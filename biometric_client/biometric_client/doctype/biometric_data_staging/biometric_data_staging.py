...
def setup_scheduled_job():
    ...
    job = frappe.get_doc({
        ...
        "method": "biometric_client.biometric_client.doctype.biometric_data_staging.biometric_data_staging.process_biometric_logs",
...
def setup_scheduled_job_for_exceptional_report():
    ...
    job = frappe.get_doc({
        "doctype": "Scheduled Job Type",
        "method": "biometric_client.biometric_client.doctype.biometric_data_staging.biometric_data_staging.send_exceptional_report",
...
def execute_scheduled_exceptional_report():
    ...
    try:
        from biometric_client.biometric_client.doctype.biometric_data_staging.biometric_data_staging import send_exceptional_report
